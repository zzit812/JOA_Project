...
<body>
	...
	%>
		<table>
			...
			<tr><td><%= list.get(i).getNotice_no() %></td><td><a href="noticeDetail.noti?noticeNo=<%= list.get(i).getNotice_no()%>"><%= list.get(i).getNotice_title() %></a></td><td><%= list.get(i).getNotice_date() %> </td></tr>
		</table>
	<%}}else{
		out.print("no");
	} %>
