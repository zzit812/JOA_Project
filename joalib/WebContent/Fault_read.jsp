		...
		<div id="cont_size">
			...
			<div id="cont_1_size">
				...
				<div id="write_box">
					...
					<div id="fault_text">
						<img
							src="<%= request.getContextPath() +"/faultImage/"+dto.getFault_attach() %>" />
				...
				<div class="button">
					...
					<input type="button" value="목록"
						onClick="location.href='Fault_list.jsp?page_num=<%= page_num%>'" />
					<%	
							if ( member_id != null && member_id.equals(dto.getMember_id())) { 
								request.setAttribute("article", dto.getMember_id());							
						%>
					<input type='button' value='수정'
						onClick="location.href='Fault_update.jsp?fault_no=<%= dto.getFault_no()%>'" />
