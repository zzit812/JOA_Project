...
<body>
	...
	<section id="book_search_size">
		...
		<main id="book_show"> <%
	  	...
	  	BookRecommendService bookRecommendService = new BookRecommendService();
	  	parse_listArr = bookRecommendService.remommend();
		...
		<div class="box">
			<a href="bookInfoDetail.bk?isbn=<%=isbn%>"> <img
				src="<%=book_img %>" class="card" src="<%=book_img %>"></a>
