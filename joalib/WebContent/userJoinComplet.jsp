...
<body>
		...
		<div id="top_size">
			...
			<nav>
				<ul id="top_nav">
					...
					<li><a href='userJoinRule.html'>회원가입</a></li> |
	...
	<section id="side_size">
		<!-- id="side_size" 이거 크기 설정한거니깐 삭제하면 안돼요 -->
		...
		<div id="cont_size">
			...
			<h1>
				<p id="userName"><%= member_name %>님
				</p>
				<br>환영합니다!
			</h1>
			<img src="img/character/character1.png" />
			<form>
				<input type="button" name="loginGo" value="LOGIN" /> <input
					type="button" name="homeGo" value="HOME" />
			</form>
		</div>
	</section>
