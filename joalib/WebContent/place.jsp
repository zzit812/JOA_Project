...
<body>
	 ...
	 %>
				...
				<ul id="top_menu">
					...
					<li><a href="#">이용안내</a>
						<ul>
							...
							<li><a href="">도서 이용 안내</a></li>
							<li><a href="">포인트 이용 안내</a></li>
		 ...
		 <div id="title"><p>오시는길</p></div>
	 </header>

	 <section id="wish_size">
	 
	 <div id="guide">
		 <p id="wish_title"><img id="img1" src="img/wish/wish.png" />위치 안내</p>
			<ul>
				<li><img class="img2" src="img/wish/wish_list.png" />지하철</li>
				<li>&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;2호선 강남역 11번 출구</li><br/>
				
				<li><img class="img2" src="img/wish/wish_list.png" />버 스</li>
				<li>&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;145, 146, 730, 341, 4312, 4420, 4421, 4422, 4424, 4431
				마을 : 3, 01-6, 10-2, 서초10, 서초 20버스</li><br/>
				
				
				<li><img class="img2" src="img/wish/wish_list.png" />주 소</li>
				<li>&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;서울시 강남구 역삼동 815-4(강남대로 428) 지수빌딩 5층, 10층.</li><br/>
				<li><img class="img2" src="img/wish/wish_list.png" />연락처</li>
				<li>&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;010-1234-5678</li><br/>
				<li><img class="img2" src="img/wish/wish_list.png" />팩스</li>
				<li>&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;02-0202-0202</li><br/>
				<li><img class="img2" src="img/wish/wish_list.png" />지도</li>
			</ul>
			
				<div id="joalib_map" style="width:85%;height:550px;"></div>
				
				<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=d8bb56473dbe59066a763c4558c39b43"></script>
				<script>
