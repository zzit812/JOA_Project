 ...
 <body>
	 ...
	 <section id="side_size">
        ...
        <div id="cont_size">
            ...
            <div id="cont_1_size">				
				<div id="write_box">                        
				<form action="faultWrite.fa" method="post" enctype="multipart/form-data" name="fuaultWriteForm" onsubmit="return writeClick();" >
				
					<input type="text" id="fault_title" name="fault_title" placeholder="제목을 입력하세요." />
					<input type="file" id="fault_attach" name="fault_attach" required="required" />					
					<textarea id="fault_text" name="fault_text" >
===================================================================
 * 사실과 다른 악의성 게시글은 포인트 회수 및 이용정지가 되니 주의하시기 바랍니다. *
===================================================================
...
불량사유: 
				...
				<script type="text/javascript">
					var fault_title = document.querySelector('#fault_title');
					var fault_text = document.querySelector('#fault_text');
					
					function writeClick(){
						if(fault_title.value.length < 1 || fault_text.value.length < 1 ){
							alert("빈칸을 입력해주세요!");
							return false;
						}else{							
							return true;
