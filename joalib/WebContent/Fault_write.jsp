...
<body>
	...
	<section id="side_size">
		...
		<div id="cont_size">
			...
			<div id="cont_1_size">
				<div id="write_box">
					<form action="faultWrite.fa" method="post"
						enctype="multipart/form-data" name="fuaultWriteForm"
						onsubmit="return writeClick();">

						<input type="text" id="fault_title" name="fault_title"
							placeholder="제목을 입력하세요." /> <input type="file" id="fault_attach"
							name="fault_attach" required="required" />
