					...
					if(list.get(i).getAlarm_check() == 0){
						if(categoryAlarm[0].equals("board")){
							...
							if(categoryAlarm[1].equals("comment")){
								...
								out.print("<a href='memberAlram.mem?alarm_date="+list.get(i).getAlarm_date()+"&boardComment_no="+list.get(i).getAlarm_etc()+"'> 회원님의 댓글에 "+ectAlarm[1]+"님이 답글을 남겼습니다.</a>");
							}
						...
						if(categoryAlarm[0].equals("board")){
							if(categoryAlarm[1].equals("comment")){
								...
								out.print("<a class='checkAlarm' href='boardHitUp.bo?board_no="+ectAlarm[2]+"> 회원님의 댓글에 "+ectAlarm[1]+"님이 답글을 남겼습니다.</a>");
							}
						}else if(categoryAlarm[0].equals("donate")){
							if(categoryAlarm[1].equals("message")){%>
