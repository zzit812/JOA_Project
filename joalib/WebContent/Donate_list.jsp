...
#board_con>ul>li:nth-child(1), #board_con>ul>li:nth-child(3), #board_con>ul>li:nth-child(4),
	#board_con>ul>li:nth-child(5), #board_con>div>ul>li:nth-child(1),
	#board_con>div>ul>li:nth-child(3), #board_con>div>ul>li:nth-child(4),
	#board_con>div>ul>li:nth-child(5) { /*게시번호*/
	width: 14%;
}
			...
			<div id="board_con">
				...
				for(int i = 0 ; i < list.size(); i++){	%>
					<ul class="donateList">
						...
						<li><a
							href="Donate_read.jsp?donate_no=<%= list.get(i).getDonate_no() %>&page_num=<%= page_num %>"><%= list.get(i).getDonate_title() %></a></li>
