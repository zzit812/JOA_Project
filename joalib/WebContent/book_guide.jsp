...
<body>
	 ...
	 %>
		 ...
		 <div id="title"><p>이용 안내</p></div>
	 </header>

	 <section id="wish_size">
	 
	 <div id="guide">
		 <p id="wish_title"><img id="img1" src="img/wish/wish.png" /> 도서 이용안내</p>
			<ul>
				<li><img class="img2" src="img/wish/wish_list.png" />대출자격</li>
				<li>&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;조아도서관 회원이며 회원증을 소지한 자</li><br/>
				
				<li><img class="img2" src="img/wish/wish_list.png" />대출가능권수</li>
				<li>&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;도서: 1인 5권</li>
				<li>&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;비도서: 1인 2점</li>
				<li>&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;대출이 불가능한 자료: 세계자료실 대사관 기증자료, 참고 도서, 시청각자료 등</li><br/>
				...
				<li>&nbsp;&nbsp;&nbsp;&nbsp;※&nbsp;예약자가 없는 경우에 한하여 연장가능</li><br/>
				<li><img class="img2" src="img/wish/wish_list.png" />연체 재재 안내</li>
				<li>&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;연체 반납시 반납일이 지난 도서의 연체 일수를 모두 합한 기간 동안 대출 정지</li>
				<li>&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;장기 연체 시 회원자격이 상실되며 조아도서관 이용과 자료대출이 불가</li><br/>
