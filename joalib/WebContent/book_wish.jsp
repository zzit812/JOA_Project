...
<body>
	...
	<section id="wish_size">
		...
		<div id="guide">
			<p id="wish_title">
				<img id="img1" src="img/wish/wish.png" /> 희망도서 신청안내
			</p>
			<ul>
				...
				<li>&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;영리목적·정치목적 자료</li>
				<li>&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;미풍양속이나 정서 등에 문제를 유발할 수 있는
					유해자료, 19세 이상 선정적인 도서</li>
				<li>&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;정기간행물과 전자자료(전자책,DVD 등 비도서) ※
					필요하다고 판단되는 경우에는 별도 비도서 구입 지침에 따름)</li>
				<li>&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;외국도서, 특정분야 전문도서</li>
				<li>&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;고가도서(5만원 이상), 외국도서, 3권을 초과하는
					시리즈 또는 전집도서, 기타 다른 기준을 적용하기 어려운 도서</li>
				<li>&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;스프링 제본 또는 낱장자료(리플릿), 입체도서,
					악보, 색칠공부, 필사 등 책 크기가 너무 작거나 소리가 나는 도서 등 이용과 관리가 어려운 형태 자료</li>
				<li>&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;소장자료나 구입중 또는 정리중 도서, 신청 또는
					주문중복도서</li>
				<li>&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;서지불명도서나 미간행도서, 비매품, 품절이나 절판
					도서</li>
				<li>&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;유사도서가 많이 소장되어 있는 경우</li>
				<li>&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;신판이 발간되었음에도 구판을 신청한 경우</li>
				<li>&nbsp;&nbsp;&nbsp;&nbsp;-&nbsp;개인 및 출판사의 영리를 목적으로 하는 자료로
					판단되는 경우</li>
				<li>&nbsp;&nbsp;&nbsp;&nbsp;※&nbsp; 희망도서 선정에서 제외된 도서 중 필요하다고
					판단되는 경우에는 정기구입 자료선정위원회에서 심의를 통해 구입</li>
			</ul>
		</div>
	</section>
	<div id="button_div">
		<input id="wish_button" Type="button" value="신청하기"
			onclick="newPostBtn()" />
	</div>
