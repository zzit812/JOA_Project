...
<%@ page import="com.joalib.DTO.DonateDTO"%>
<%@ page import="com.joalib.donate.action.*"%>
...
<body>
	...
	<section id="side_size">
		...
		<div id="cont_size">
			...
			<div id="cont_1_size">
				<div id="write_box">
					<form action='donatePostUpdate.don' name="donateUpdate"
						method="post">
						<input type="hidden" name="donate_no" value="<%= donate_no%>" />
						<input type="text" name="donate_title" id="donate_title"
							value="<%= dto.getDonate_title()%>" />
						<textarea id="donate_text" name="donate_text"><%= dto.getDonate_text()%></textarea>
						<input class="button" type="submit" onClick="alert('수정되었습니다');"
							value="등록" /> <a href="javascript:history.go(-1)"><input
