...
#loginForm>input[name=menu_loginBtn]:hover {
	background-color: rgb(23 27 55/ 85%);
}
...
<body>
	<form action="">
		<header>
			<a href="home.jsp"><img alt="JOA Library" src="img/Logo_1.png"
				id="logo_joa" /></a>
			...
			if((String)session.getAttribute("member_id") != null){//세션값이 있으면 
				...
				<div>
					<span class="clickCircle"></span><a href='memberLogout.mem'>LOGOUT</a>
				</div>
				<%}else{	//세션값이 없으면%>
				<div>
					<span class="clickCircle"></span><a href='userLogin.html'>LOGIN</a>
				</div>
				<div>
					<span class="clickCircle"></span><a href='userJoinRule.html'>JOIN</a>
				</div>
				<%}%>
			</div>
			<nav>
				<div id="MainMenu">
					<ul>
						<li><a href="#"><img alt="Search_icon"
								src="img/icon_search.png" /><span>Search</span></a></li>
						<li><a href="#"><img alt="Books_icon"
								src="img/icon_book.png" /><span>Books</span></a>
							<ul>
								<li><a href="#">신착도서</a></li>
								<li><a href="#">베스트셀러</a></li>
								<li><a href="#">희망도서 신청</a></li>
							</ul></li>
						<li><a href="#"><img alt="Guidance_icon"
								src="img/icon_guide.png" /><span>Guidance</span></a>
							<ul>
						...
						<li><a href="#"><img alt="Community_icon"
								src="img/icon_community.png" /><span>Community</span></a>
							<ul>
								<li><a href="#">공지사항</a></li>
						...
						<li><a href="#"><img alt="Mypage_icon"
								src="img/icon_my.png" /><span>MyPage</span></a></li>
					</ul>

					<div id="mainMenuSub">

						<div id="searchBar">
							<input type="text" placeholder="도서를 검색하세요! ヾ(´｡••｡`)ﾉ" /> <input
								type="image" src="img/icon_search.png" alt="searchingBtn">
						</div>
						<%if(member_id == null){%>
						<div id="loginForm">
							<div>
							...
							<input type="button" name="menu_loginBtn" value="LOGIN" /> <a
								href="#">회원이 아니신가요?</a>
						</div>
						<% }else{ %>
						<div id="menuMyInfo">
							<div>
								<div id="menuMyInfoImg">
									<img alt="프로필" src="img/icon_search.png">
								</div>
		...
		<section>
			...
			<article id="searchBar2">
				<input type="text" placeholder="찾으시는 도서를 검색하세요!	:-)" /> <input
					type="image" src="img/icon_search.png" alt="searchingBtn">
			</article>
		</section>
